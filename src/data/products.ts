...
export const products: Product[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    images: [
      ...
      {
        src: "/images/brood-1412-cedar-angle.jpg",
        alt: "14x12 Brood Box (Assembled, Cedar) - Angle View",
      },
      {
        src: "/images/brood-1412-cedar-side.jpg",
        alt: "14x12 Brood Box (Assembled, Cedar) - Side View",
      },
      {
        src: "/images/brood-1412-cedar-detail.jpg",
        alt: "14x12 Brood Box (Assembled, Cedar) - Joint Detail",
      },
    ],
  },
